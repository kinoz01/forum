...
func ServeCloudError(w http.ResponseWriter, err error, msg1, msg2 string, statusCode int) {
	log.Println(err)
...
// GetErrorPage retrieves the error page from Cloud based on the error code.
